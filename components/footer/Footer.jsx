...
const Footer = () => {
  return (
    <div className="py-5 mt-40 bg-amber-50 flex justify-center items-center gap-2 md:gap-10 right-0 absolute left-0">
    <p>Local Food-Express made with 💚 by AMAKA </p>
