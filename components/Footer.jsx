...
const Footer = () => {
  return (
    <footer>
      <div className="max-w-[100%] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-amber-100">

        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center">
          <Link href="/">
            <a className="text-2xl font-bold text-black hover:text-[#A1C75C]">Local Food-Express</a>
          </Link>
